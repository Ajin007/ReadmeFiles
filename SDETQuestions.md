1. When we will get the java.util.InputMismatchException? ---> when i use the nextInt() for the String input we will get this in the during the exception in the run Time.
